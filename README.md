...
Performance analytics (Duration, WPM, Confidence)
Filler word detection
AI-generated interactive questions (Level 2)
Gamification system (XP, badges, levels)
Progressive level-based practice

instalation commands 
Install Python on your system.
2️⃣ Create a virtual environment (recommended but optional).
...
SpeechRecognition
Pydub
5️⃣ Install FFmpeg (needed for audio processing).
